...
type FeaturesAndAminitiesType = {
    featuresAndAminities: Property["features"]
}

export default function FeaturesAndAminities({
    featuresAndAminities
} : FeaturesAndAminitiesType){

    const isMobile = useMediaQuery({maxWidth: 767})
    

        const items = getPropertyFeatures(featuresAndAminities)
    return(
