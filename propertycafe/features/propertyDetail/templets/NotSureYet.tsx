...
export default function NotSureYet(){
    return(
        <div className="flex justify-center items-center gap-2 w-[80%]">
            <Image src="/featuredproduct1.jpg" alt="productImage" width={127} height={100} className="w-full rounded-xl h-full" ></Image>
            <div className="flex flex-col gap-1 ">
                ...
                <div className={`flex gap-1 `}>
                                        <div className="flex items-center shadow  gap-1 w-fit rounded-md h-fit py-1 px-3  bg-white">
                                            <Image src="/love.png" alt="love" width={14} height={14} className="w-[14px] h-[14px]"></Image>
                                        ...
                                        <div className="flex items-center shadow gap-1 rounded-md w-fit h-fit px-3 py-1  bg-white">
                                            <Image src="/share.png" alt="share" width={14} height={14} className="w-[12px] h-[12px]"></Image>
