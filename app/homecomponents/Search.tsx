                    ...
                    <div className={`flex  gap-3 items-center ml-[7px]`}>
                        ...
                        <div className="group flex gap-3 items-center">
                            ...
                            recentSearches.slice(0,2).map((item,id)=>(
                                <div key={id} className={`${id == 1 ? "bg-[#923EE852] text-[12px]  px-2 py-1 rounded-md flex items-center justify-center":" text-[clamp(0.8rem,4vw,0.9rem)]"} hover:-translate-y-[2px] transition-transform duration-300 cursor-pointer `}>
                                    <p className={``}>{item}</p>
                                </div>
                            ))
                        }
