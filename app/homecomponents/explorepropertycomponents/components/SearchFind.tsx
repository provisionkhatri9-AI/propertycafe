    ...
    return(
        ...
        <div className={` mb-10 flex justify-between px-4 py-5 rounded-xl shadow ${isMobile? "flex-col items-center" : "flex-row"}`}>
            <div className="flex flex-col">
                <div>
                    <p className="font-bold text-[clamp(1.4rem,3vw,2rem)] leading-[140%] text-[#A044FF]">Can't find what you are looking for?</p>
                </div>
                <div>
            ...
            <div className="flex flex-col items-center">
                <Image src="/searchallhome.png" alt="" width={200} height={200} className="w-full h-full"></Image>
                {
                    isMobile&&
                    <Button></Button>
                }
