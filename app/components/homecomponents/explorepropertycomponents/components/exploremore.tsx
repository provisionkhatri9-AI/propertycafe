...
export default function ExploreMore(){
    ...
    return(
        <div className="mb-10 w-full flex flex-col gap-2 ">
            <div>
                <p className="text-[clamp(1.3rem,4vw,2rem)] font-bold">Explore More Properties</p>
            </div>

            <div className="flex sm:justify-start sm:gap-20 justify-between border-b-1 border-[#F0EAF4] pb-2">
