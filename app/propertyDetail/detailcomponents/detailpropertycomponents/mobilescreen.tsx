    ...
    <div className={`flex overflow-x-auto  gap-2 p-3 ${isMobile ? "w-[90vw]" : "w-[80vw]"} scrollbar-hide `}>
            {
                property.priceAndFloor.map((items,id)=>(
                    <div key={id} className="shadow flex flex-col shrink-0 h-fit  rounded-xl p-3">
                ...
                <div className="flex justify-between">
                    ...
                    <div className="max-w-[18px] min-w-[16px] max-h-[18px] min-h[18px]">
                        <Image src="/squareandline.png" alt="hello" width={18} height={18} className="w-full w-full"></Image>
                    </div>
                    <div className="flex flex-col gap-1">
                        <p className="text-[14px] text-[#111116] leading-[59%] font-medium">{items.area}</p>
                ...
                <div className="flex gap-2 items-center justify-center w-full h-full">
                    ...
                    <div className="flex flex-col gap-1">
                        <p className="text-[14px] text-[#111116] leading-[59%] font-medium">{items.price}</p>
