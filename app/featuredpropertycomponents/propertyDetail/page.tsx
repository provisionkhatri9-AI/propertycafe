        ...
        <div className={`flex flex-col ${isMobile ? "gap-0" : "gap-3"}  w-[88vw] `}>
            <div className={` ${isMobile ? "mt-[-25px]" : "mt-14"} flex justify-between `}>
                ...
                <div  className="flex flex-col gap-2">
                    <p className="font-bold text-[clamp(1rem,4vw,1.1rem)] leading-[140%]">Bhandari Niwas for Sale in Budhanilkaltha, Kathmandu</p>
                    <div className="flex gap-1 items-center">
                        <p>⚲</p>
                        <p className="text-[14px] leading-[140%]">Central Mall, Kathmandu 44800</p>
                    </div>
                    ...
                    {
                        isMobile&&
                        <div className="bg-[#F0A300] flex items-center justify-center gap-3 px-5 py-3 rounded-xl">
