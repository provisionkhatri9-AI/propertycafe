...
export default function Rating(){
    ...
    return(
        <div className="">
            ...
            <div className={`flex shadow p-4 mt-2 rounded-xl  ${isMobileLittle? "-translate-x-[2px]" : "justify-center"} w-full   gap-2`}>
                <div className="flex flex-col gap-2 h-[96px]  w-[154px] relative flex items-center justify-center">
